...
Features
----------------------------------------------------------
1) **Separate Dimension.** Live in both modern and old
   Minecraft. Beta dimension is accessible from both the
   Overworld and the Nether. Overworld: reinforced bedrock
   portal frame + beta fire. Nether: crying obsidian
   portal frame + beta fire.
2) **Separate Seed.** Beta dimension can have a separate
...
7) **Old Procedural Fire/Lava Textures.** In Beta 1.7.3
...
Credits
----------------------------------------------------------
Mod uses bush leaves and sapling textures from [Better
than Adventure](https://www.betterthanadventure.net/) mod for Beta 1.7.3. Bushes can be found
in savanna and shrubland.