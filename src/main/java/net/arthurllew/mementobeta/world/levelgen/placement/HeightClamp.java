...
public class HeightClamp extends PlacementFilter {
     ...
     * Codec.
     */
    public static final MapCodec<HeightClamp> CODEC = RecordCodecBuilder.mapCodec((values)
            -> values.group(
                    ...
                    Codec.INT.optionalFieldOf("max_inclusive", Integer.MAX_VALUE)
                            .forGetter((heightClamp) -> heightClamp.maxInclusive)
            ).apply(values, HeightClamp::new));
