...
public class NoiseGeneratorPerlin {
    ...
    public NoiseGeneratorPerlin(Random random) {
        this.x = random.nextDouble() * 256.0D;
        this.y = random.nextDouble() * 256.0D;
        this.z = random.nextDouble() * 256.0D;
    ...
    public void sample(double[] var1, double var2, double var4, double var6, int var8, int var9, int var10, double var11, double var13, double var15, double var17) {
        int var10001;
        int var19;
        int var22;
        double var31;
        ...
        if(var9 == 1) {
            ...
            for(int var30 = 0; var30 < var8; ++var30) {
                var31 = (var2 + (double)var30) * var11 + this.x;
                int var78 = (int)var31;
                ...
                for(var37 = 0; var37 < var10; ++var37) {
                    var38 = (var6 + (double)var37) * var15 + this.z;
                    var40 = (int)var38;
                    ...
                    double var70 = this.lerp(var35, this.func_4110_a(this.permutations[var66], var31, var38), this.grad(this.permutations[var22], var31 - 1.0D, 0.0D, var38));
                    double var73 = this.lerp(var35, this.grad(this.permutations[var66 + 1], var31, 0.0D, var38 - 1.0D), this.grad(this.permutations[var22 + 1], var31 - 1.0D, 0.0D, var38 - 1.0D));
            ...
            for(var37 = 0; var37 < var8; ++var37) {
                var38 = (var2 + (double)var37) * var11 + this.x;
                var40 = (int)var38;
                if(var38 < (double)var40) {
                    --var40;
                }
                ...
                for(int var44 = 0; var44 < var10; ++var44) {
                    double var45 = (var6 + (double)var44) * var15 + this.z;
                    int var47 = (int)var45;
                    ...
                    for(int var51 = 0; var51 < var9; ++var51) {
                        double var52 = (var4 + (double)var51) * var13 + this.y;
                        int var54 = (int)var52;
